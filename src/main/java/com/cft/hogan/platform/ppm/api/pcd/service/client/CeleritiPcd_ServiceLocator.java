...
public class CeleritiPcd_ServiceLocator extends org.apache.axis.client.Service implements com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_Service {
    ...
    public com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_PortType getCeleritiPcd() throws javax.xml.rpc.ServiceException {
    ...
    public com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_PortType getCeleritiPcd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_BindingStub _stub = new com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_BindingStub _stub = new com.cft.hogan.platform.ppm.api.pcd.service.client.CeleritiPcd_BindingStub(new java.net.URL(CeleritiPcd_address), this);
                _stub.setPortName(getCeleritiPcdWSDDServiceName());
                return _stub;
            }
        }
