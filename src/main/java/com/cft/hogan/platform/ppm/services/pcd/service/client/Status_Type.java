...
public class Status_Type  implements java.io.Serializable {
    ...
    private com.cft.hogan.platform.ppm.services.pcd.service.client.SubjectElement_Type[] subjectElement;

    private com.cft.hogan.platform.ppm.services.pcd.service.client.AdditionalStatus_Type[] additionalStatus;

    private com.cft.hogan.platform.ppm.services.pcd.service.client.AsyncRsData_Type asyncRsData;
    ...
    public Status_Type(
           ...
           com.cft.hogan.platform.ppm.services.pcd.service.client.SubjectElement_Type[] subjectElement,
           com.cft.hogan.platform.ppm.services.pcd.service.client.AdditionalStatus_Type[] additionalStatus,
           com.cft.hogan.platform.ppm.services.pcd.service.client.AsyncRsData_Type asyncRsData) {
     ...
     */
    public com.cft.hogan.platform.ppm.services.pcd.service.client.SubjectElement_Type[] getSubjectElement() {
        return subjectElement;
    }
     ...
     */
    public void setSubjectElement(com.cft.hogan.platform.ppm.services.pcd.service.client.SubjectElement_Type[] subjectElement) {
        this.subjectElement = subjectElement;
    }

    public com.cft.hogan.platform.ppm.services.pcd.service.client.SubjectElement_Type getSubjectElement(int i) {
        return this.subjectElement[i];
    }

    public void setSubjectElement(int i, com.cft.hogan.platform.ppm.services.pcd.service.client.SubjectElement_Type _value) {
     ...
     */
    public com.cft.hogan.platform.ppm.services.pcd.service.client.AdditionalStatus_Type[] getAdditionalStatus() {
        return additionalStatus;
    }
     ...
     */
    public void setAdditionalStatus(com.cft.hogan.platform.ppm.services.pcd.service.client.AdditionalStatus_Type[] additionalStatus) {
        this.additionalStatus = additionalStatus;
    }

    public com.cft.hogan.platform.ppm.services.pcd.service.client.AdditionalStatus_Type getAdditionalStatus(int i) {
        return this.additionalStatus[i];
    }

    public void setAdditionalStatus(int i, com.cft.hogan.platform.ppm.services.pcd.service.client.AdditionalStatus_Type _value) {
     ...
     * @return asyncRsData
     */
    public com.cft.hogan.platform.ppm.services.pcd.service.client.AsyncRsData_Type getAsyncRsData() {
        return asyncRsData;
    }
     ...
     * @param asyncRsData
     */
    public void setAsyncRsData(com.cft.hogan.platform.ppm.services.pcd.service.client.AsyncRsData_Type asyncRsData) {
        this.asyncRsData = asyncRsData;
    }
