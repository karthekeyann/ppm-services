...
public class CeleritiPcdProxy implements com.cft.hogan.platform.ppm.services.pcd.service.client.CeleritiPcd_PortType {
  private String _endpoint = null;
  private com.cft.hogan.platform.ppm.services.pcd.service.client.CeleritiPcd_PortType celeritiPcd_PortType = null;
  ...
  private void _initCeleritiPcdProxy() {
    try {
      celeritiPcd_PortType = (new com.cft.hogan.platform.ppm.services.pcd.service.client.CeleritiPcd_ServiceLocator()).getCeleritiPcd();
  ...
  public com.cft.hogan.platform.ppm.services.pcd.service.client.CeleritiPcd_PortType getCeleritiPcd_PortType() {
    if (celeritiPcd_PortType == null)
      _initCeleritiPcdProxy();
