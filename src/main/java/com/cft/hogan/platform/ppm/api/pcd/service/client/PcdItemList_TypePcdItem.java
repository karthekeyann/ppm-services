...
public class PcdItemList_TypePcdItem  implements java.io.Serializable {
    private com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItemPcdItemKey[] pcdItemKey;

    private com.cft.hogan.platform.ppm.api.pcd.service.client.PcdData_Type pcdData;

    private com.cft.hogan.platform.ppm.api.pcd.service.client.PcdWorkArea pcdWorkArea;
    ...
    public PcdItemList_TypePcdItem(
           com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItemPcdItemKey[] pcdItemKey,
           com.cft.hogan.platform.ppm.api.pcd.service.client.PcdData_Type pcdData,
           com.cft.hogan.platform.ppm.api.pcd.service.client.PcdWorkArea pcdWorkArea,
     ...
     * @return pcdItemKey
     */
    public com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItemPcdItemKey[] getPcdItemKey() {
        return pcdItemKey;
    }
     ...
     * @param pcdItemKey
     */
    public void setPcdItemKey(com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItemPcdItemKey[] pcdItemKey) {
        this.pcdItemKey = pcdItemKey;
    }

    public com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItemPcdItemKey getPcdItemKey(int i) {
        return this.pcdItemKey[i];
    }

    public void setPcdItemKey(int i, com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItemPcdItemKey _value) {
     ...
     * @return pcdData
     */
    public com.cft.hogan.platform.ppm.api.pcd.service.client.PcdData_Type getPcdData() {
        return pcdData;
    }
     ...
     * @param pcdData
     */
    public void setPcdData(com.cft.hogan.platform.ppm.api.pcd.service.client.PcdData_Type pcdData) {
        this.pcdData = pcdData;
    }
     ...
     * @return pcdWorkArea
     */
    public com.cft.hogan.platform.ppm.api.pcd.service.client.PcdWorkArea getPcdWorkArea() {
        return pcdWorkArea;
    }
     ...
     * @param pcdWorkArea
     */
    public void setPcdWorkArea(com.cft.hogan.platform.ppm.api.pcd.service.client.PcdWorkArea pcdWorkArea) {
        this.pcdWorkArea = pcdWorkArea;
    }
