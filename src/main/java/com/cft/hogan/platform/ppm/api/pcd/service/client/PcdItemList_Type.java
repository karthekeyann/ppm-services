...
public class PcdItemList_Type  implements java.io.Serializable {
    private com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItem[] pcdItem;
    ...
    public PcdItemList_Type(
           com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItem[] pcdItem,
     ...
     * @return pcdItem
     */
    public com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItem[] getPcdItem() {
        return pcdItem;
    }
     ...
     * @param pcdItem
     */
    public void setPcdItem(com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItem[] pcdItem) {
        this.pcdItem = pcdItem;
    }

    public com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItem getPcdItem(int i) {
        return this.pcdItem[i];
    }

    public void setPcdItem(int i, com.cft.hogan.platform.ppm.api.pcd.service.client.PcdItemList_TypePcdItem _value) {
